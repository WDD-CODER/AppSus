...
function _createMails() {
    ...
    if (!mails || !mails.length) {
        mails = [
            ...
            { id: 'e103', createdAt: 1678972800000, subject: 'Meeting Reminder', body: 'Reminder: Our meeting is tomorrow at 10 AM.', isRead: false, sentAt: 1678972805000, removedAt: null, from: 'calendar@appsus.com', to: 'user@appsus.com' },
            { id: 'e104', createdAt: 1679059200000, subject: 'Your Order Shipped!', body: 'Good news! Your recent order has shipped.', isRead: true, sentAt: 1679059215000, removedAt: null, from: 'noreply@store.com', to: 'user@appsus.com' },
            ...
            { id: 'e112', createdAt: 1679750400000, subject: 'Your Subscription Expiring', body: 'Action required: Your subscription is expiring soon.', isRead: false, sentAt: 1679750490000, removedAt: null, from: 'accounts@service.com', to: 'user@appsus.com' },
            ...
            { id: 'e114', createdAt: 1679923200000, subject: 'Welcome to Our Service', body: 'Thank you for joining! Here\'s how to get started.', isRead: false, sentAt: 1679923299000, removedAt: null, from: 'welcome@onboarding.com', to: 'user@appsus.com' },
